...
- `git clone https://github.com/UniversalPropositions/UP_Czech-CAC.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Czech-CAC>/ --input_up=<up_path_to_UP_Czech-CAC>/ --output=<path_to_UD+UP_Czech-CAC>/`
